...
## uCODEC 1.0 
### A 5cm x 5cm CODEC board using Analog Device AD1939
...
3. Download this project to C:\Electronics\OHDSP\uCODEC
4. Fire up Kicad
5. Open the main project file C:\Electronics\OHDSP\uCODEC\KiCad\uCODEC.pro
